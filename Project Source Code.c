...
int cacheSimulation(int t){
  ...
  //  numAccesses = getValidIntegerInput("Enter the number of memory access attempts to simulate (1-1000): ", 1);
 // User input
...
void runPredefinedAddressPattern( int numAccesses) {
    ...
    if (seqAddresses) {
        ...
        for (int i = 0; i < numAccesses; i++) {
            seqAddresses[i] = (i * WORD_SIZE) % ADDRESS_SPACE;  // Sequential addresses
        }
    ...
    if (randomAddresses) {
        ...
        for (int i = 0; i < numAccesses; i++) {
            randomAddresses[i] = (rand() % (ADDRESS_SPACE / WORD_SIZE)) * WORD_SIZE;  // Random addresses
        }
...
void runCacheMappingComparison() {
    ...
    printf("Enter number of memory accesses to simulate [default: %d]: ", numAccesses);
...
int main() {
 ...
 while(true){
   ...
   printf("-----------------------------\n");
    ...
    printf("4. Comparision and Analysis of All Tree Mapping Technique\n");
    printf("0. Exit\n\n");
    ...
    scanf("%d",&choice);
        ...
        if(choice == 1)
        {
            while(true)
            {
                ...
                printf("-----------------------------\n\n");
                printf("1. Simulate Direct Mapping working mechanism.\n");
                printf("2. Analyze cache performance with large number of addresses.\n");
                printf("0. Exit\n\n");
                printf("Choose an option: ");
                scanf("%d",&choice);
            ...
            while(true)
            {
                ...
                printf("-----------------------------\n\n");
                printf("1. Simulate Fully Associative  Mapping working mechanism.\n");
                printf("2. Analyze cache performance with large number of addresses.\n");
                printf("0. Exit\n\n");
                printf("Choose an option: ");
                scanf("%d",&choice);
